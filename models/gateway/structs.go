...
type Stat struct {
	...
	CPU    uint32       `json:"cpu,omitempty"`   // Number of packets emitted (unsigned integer)
	Memf   uint32       `json:"memf,omitempty"`  // Number of packets emitted (unsigned integer)
	Memd   uint32       `json:"memd,omitempty"`  // Number of packets emitted (unsigned integer)
	Discf  uint32       `json:"discf,omitempty"` // Number of packets emitted (unsigned integer)
	Discd  uint32       `json:"discd,omitempty"` // Number of packets emitted (unsigned integer)
	Uptime uint32       `json:"age,omitempty"`
	MD5    string       `json:"md5,omitempty"`
}
